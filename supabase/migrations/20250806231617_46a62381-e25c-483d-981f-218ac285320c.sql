...
-- Fix infinite recursion issue with security definer function
...
DROP POLICY IF EXISTS "Admins can view all companies" ON public.profiles;
...
-- Apply similar patterns to financial statement tables
