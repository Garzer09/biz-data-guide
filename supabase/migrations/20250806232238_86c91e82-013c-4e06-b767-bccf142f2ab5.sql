-- Drop existing audit_log policies first
DROP POLICY IF EXISTS "Users can view relevant audit_log" ON public.audit_log;
...
DROP POLICY IF EXISTS "Only admins can manage periods" ON public.periods;
DROP POLICY IF EXISTS "Users can view fs_income for assigned companies" ON public.fs_income;
DROP POLICY IF EXISTS "Only admins can manage fs_income" ON public.fs_income;
DROP POLICY IF EXISTS "Users can view fs_balance for assigned companies" ON public.fs_balance;
DROP POLICY IF EXISTS "Only admins can manage fs_balance" ON public.fs_balance;
DROP POLICY IF EXISTS "Users can view fs_cashflow for assigned companies" ON public.fs_cashflow;
DROP POLICY IF EXISTS "Only admins can manage fs_cashflow" ON public.fs_cashflow;
DROP POLICY IF EXISTS "Users can view ratios_calc for assigned companies" ON public.ratios_calc;
DROP POLICY IF EXISTS "Only admins can manage ratios_calc" ON public.ratios_calc;
DROP POLICY IF EXISTS "Authenticated users can view company_pages" ON public.company_pages;
DROP POLICY IF EXISTS "Only admins can manage company_pages" ON public.company_pages;
DROP POLICY IF EXISTS "Users can view import_jobs for assigned companies" ON public.import_jobs;
DROP POLICY IF EXISTS "Only admins can manage import_jobs" ON public.import_jobs;
DROP POLICY IF EXISTS "Users can view import_files for assigned companies" ON public.import_files;
DROP POLICY IF EXISTS "Only admins can manage import_files" ON public.import_files;
